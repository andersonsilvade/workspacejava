...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public void setEspecificacaoMaterial(EspecificacaoMaterial esp){
		this.esp = esp;
	}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public boolean comparar(Material buscar){
		if (!this.codigoMaterial.equals(buscar.codigoMaterial))//||(!this.getEsp().equals(buscar.getEsp().getNome())))
			return false;
		return true;
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////
