...
public class Agenda {
	...
	private Vector<Professor>professor;
	Scanner scanner = new Scanner(System.in);
	
	public Agenda(){
		alunos = new Vector<Aluno>();
		professor = new Vector<Professor>();
	...
	public void addAluno(){
				...
				System.out.println("Insira o nº Matricula: ");
	...
	public void addProfessor(){
				...
				System.out.println("Insira um email: ");
				String email = scanner.next();
				System.out.println("Insira o nº Registro: ");
	...
	public void editarContato(){
		...
		for(Aluno editado : alunos){
			if(editado.getNome().equals(nome)){
		               ...
		               System.out.println("4 - editar número matricula");
		...
		if(opc == 2){
			...
			for(Professor editado : professor){
				if(editado.getNome().equals(nome)){
			               ...
			               System.out.println("2 - editar telefone");
			               System.out.println("3 - editar email");
			               System.out.println("4 - editar número regitro");
	...
	public void setProfessor(Vector<Professor> professor) {
