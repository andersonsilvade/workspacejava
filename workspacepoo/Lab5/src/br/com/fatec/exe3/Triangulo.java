...
public class Triangulo {
	...
	public static void main(String[] args) {
		...
		if(hip ==(int) Math.sqrt( Math.pow(cA, 2)+Math.pow(cB, 2))){
			System.out.println("Essas medidas podem representar um triângulo retângulo");
		}else{
			System.out.println("Essa medidas não representam as medidas de um triângulo retângulo");
		}
	}
